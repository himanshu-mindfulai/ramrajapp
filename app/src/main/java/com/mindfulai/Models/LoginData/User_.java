...
public class User_ implements Parcelable {
    ...
    private GoogleLoginData google;
    private DocsModel docs;
    ...
    protected User_(Parcel in) {
        ...
        this.google = in.readParcelable(GoogleLoginData.class.getClassLoader());
        ...
        this.docs = in.readParcelable(DocsModel.class.getClassLoader());
    }
    ...
    public DocsModel getDocs() {
        return docs;
    }

    public void setDocs(DocsModel docs) {
        this.docs = docs;
    }

    public GoogleLoginData getGoogle() {
        return google;
    }

    public void setGoogle(GoogleLoginData google) {
        this.google = google;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.docs, flags);
    }
}